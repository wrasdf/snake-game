...
Consolidate all test-related files into a dedicated `./tests` directory to improve project organization, make test infrastructure clear, and maintain full test functionality.
